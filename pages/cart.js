...
const ColumnsWrapper = styled.div`
    ...
    margin-top: 40px;
`
const ColumnsWrapperTwo = styled.div`
    display: grid;
    gap: 40px;
    width: 70%;
    margin-top: 40px;
            ...
            <>
                ...
                <ColumnsWrapperTwo>
                    ...
                    <div>
                        ...
                        <p>Te enviaremos un correo cuando tu órden sea enviada.</p>   
                    </div>
                            ...
                            <tbody>
                                {products?.map(product => (
                                    <tr key={product._id}>
                                        ...
                                        <td>
                                            <Button primary onClick={() => lessOfThisProduct(product._id)}>-</Button>
                                            <QuantityLabel>
